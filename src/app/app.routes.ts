...
import {D01s01InputComponent} from './d01-basic/step01/d01s01-input.component';
import {D01s02InputComponent} from './d01-basic/step02/d01s02-input.component';

export const routes: Routes = [
  {path: '', redirectTo: 'd01-s01-input', pathMatch: 'full'},
  {path: 'd01-s01-input', component: D01s01InputComponent},
  {path: 'd01-s02-input', component: D01s02InputComponent},
